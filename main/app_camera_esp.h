...
// Default to ESP-S3-EYE when no camera module is configured in sdkconfig.
#if !CONFIG_CAMERA_MODULE_WROVER_KIT && \
    !CONFIG_CAMERA_MODULE_ESP_EYE && \
    !CONFIG_CAMERA_MODULE_ESP_S2_KALUGA && \
    !CONFIG_CAMERA_MODULE_ESP_S3_EYE && \
    !CONFIG_CAMERA_MODULE_ESP32_CAM_BOARD && \
    !CONFIG_CAMERA_MODULE_M5STACK_PSRAM && \
    !CONFIG_CAMERA_MODULE_M5STACK_WIDE && \
    !CONFIG_CAMERA_MODULE_AI_THINKER && \
    !CONFIG_CAMERA_MODULE_CUSTOM
